...
const SettingsPage = () => {
  ...
  // Avatar lives in AuthContext so Navbar and Sidebar
  // can display the same profile photo.
  ...
  const handleFileChange = (e) => {
    ...
    // Preview locally and update AuthContext.
  ...
  const handleRemove = () => {
    ...
    // TODO: Call DELETE /api/users/me/avatar on the backend.
  };
        ...
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-slate-400">
              JPG or PNG, at least 200×200px, max 5MB.
            </p>
          </div>
        </div>
